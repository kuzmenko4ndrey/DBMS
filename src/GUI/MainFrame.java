...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        picture.setPreferredSize(new java.awt.Dimension(100, 100));
    ...
    private void addTableButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addTableButtonActionPerformed
        AddTableFrame atf = new AddTableFrame(this, db);
    ...
    private void getDiffBtwTablesButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getDiffBtwTablesButtonActionPerformed
        ...
        list1.removeAll();
        ArrayList<String> als = db.getDiffBetwnTabls(tableChooser.getSelectedItem(), s);
    ...
    private void list1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_list1MouseClicked
        ...
        String p = db.getTable(tableChooser.getSelectedItem()).getData().get(
                list1.getSelectedIndex()).get(db.getTable(
                        tableChooser.getSelectedItem()).
                        getPictureIndex()).toString();
        if (!p.equals("")) {
