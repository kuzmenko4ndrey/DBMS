 ...
 * @author Neophron
 */
public class Table extends PortableRemoteObject implements ITable {
    ...
    protected Table(String tname, TableScheme tscheme) throws java.rmi.RemoteException {
        name = tname;
        scheme = tscheme;
    }
    ...
    protected ArrayList<String> getDiffBetwnTabls(Table t2) throws RemoteException {
        Table t = this.scheme.createTable("result");
        for (ArrayList<Object> al : this.getData()) {
            t.addRow(al);
        }
