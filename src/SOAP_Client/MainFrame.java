...
import SOAP_Server.DB;
import SOAP_Server.DBM;
import SOAP_Server.IDBM;
...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() {
        ...
        URL url = null;
        try {
            url = new URL("http://localhost:6112/wss/DBM?wsdl");
        } catch (MalformedURLException ex) {
            Logger.getLogger(MainFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        QName qname = new QName("http://SOAP_Server/", "DBMService");
